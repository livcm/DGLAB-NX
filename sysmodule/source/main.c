...
int main(int argc, char* argv[])
{
    ...
    // Boot does as little as possible: the lock and the session core (random
    // source, controller id, log ring). No threads, no services beyond csrng.
    // The socket server is deliberately NOT started here - holding sockets
