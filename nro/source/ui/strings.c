...
static const char* const kKeys[DglabString_Count] = {
    ...
    [DglabString_ActionConfirm] = "action_confirm",
    ...
    [DglabString_MotionChannels] = "motion_channels",
    [DglabString_MotionLink] = "motion_link",
    [DglabString_MotionVolume] = "motion_volume",
    [DglabString_MotionChannelA] = "motion_channel_a",
    [DglabString_MotionChannelB] = "motion_channel_b",
    [DglabString_MotionLastCmd] = "motion_last_cmd",
    ...
    [DglabString_MotionDesc] = "motion_desc",
    [DglabString_MotionSafety] = "motion_safety",
    [DglabString_LinkNotStarted] = "link_not_started",
    [DglabString_LinkWaiting] = "link_waiting",
    [DglabString_LinkPaired] = "link_paired",
    [DglabString_LinkStopped] = "link_stopped",
    [DglabString_LinkFailed] = "link_failed",
    [DglabString_LinkIpcFailed] = "link_ipc_failed",
    ...
    [DglabString_DescGyroWeight] = "desc_gyro_weight",
    [DglabString_DescAccelWeight] = "desc_accel_weight",
    ...
    [DglabString_RowClear] = "row_clear",
    [DglabString_LabelChannelA] = "label_channel_a",
    [DglabString_LabelChannelB] = "label_channel_b",
    [DglabString_SocketPort] = "socket_port",
    [DglabString_LabelState] = "label_state",
    [DglabString_LabelAddress] = "label_address",
    [DglabString_LabelController] = "label_controller",
    ...
    [DglabString_LabelLastIssue] = "label_last_issue",
    [DglabString_CommandLabel] = "command_label",
    [DglabString_LabelStrength] = "label_strength",
    ...
    [DglabString_IssueNone] = "issue_none",
    [DglabString_QrHint] = "qr_hint",
    [DglabString_QrNotRunning] = "qr_not_running",
    [DglabString_QrNoAddress] = "qr_no_address",
    ...
    [DglabString_CmdStart] = "cmd_start",
    [DglabString_CmdStop] = "cmd_stop",
