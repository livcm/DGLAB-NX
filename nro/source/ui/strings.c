...
static const char* const kKeys[DglabString_Count] = {
    ...
    [DglabString_BleSoftLimit] = "ble_soft_limit",
    [DglabString_BleStrength] = "ble_strength",
    [DglabString_BlePackets] = "ble_packets",
    [DglabString_BleOpenLoop] = "ble_open_loop",
    [DglabString_BleProcedure] = "ble_procedure",
